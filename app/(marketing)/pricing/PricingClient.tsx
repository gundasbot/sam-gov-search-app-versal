...
const PLANS: {
...
}[] = [
  {
    ...
    features: [
      '1 user seat',
      'Full SAM.gov opportunity search',
      'CSV exports',
      'Email alerts',
      'Basic filtering & keyword search',
    ],
    notIncluded: ['Additional user seats', 'API access', 'Dedicated support', 'Custom integrations'],
  },
  {
    id: 'PROFESSIONAL',
    name: 'Professional',
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'A user seat is one individual login account under your subscription. Each person on your team who needs access to the platform counts as one seat.',
  },
  {
