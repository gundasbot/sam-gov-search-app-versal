  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      const searchesArray = Array.isArray(searches)
        ? searches
        : (Array.isArray(searches?.searches) ? searches.searches : [])
                      ...
                      {!isAuthenticated && (
                        <div className="absolute inset-0 rounded-xl z-10 flex items-end p-4">
                          <div className="w-full px-3 py-2 bg-slate-900/80 backdrop-blur-sm border border-teal-600/40 rounded-lg flex items-center justify-between">
                            ...
                            <Link href="/auth/signin" className="text-xs text-white bg-teal-600 hover:bg-teal-500 px-2.5 py-1 rounded-lg font-bold transition-colors">Sign In</Link>
                          </div>
                        </div>
                      )}
                      ...
                      {!isAuthenticated && (
                        <div className="absolute inset-0 rounded-xl z-10 flex items-end p-4">
                          <div className="w-full px-3 py-2 bg-slate-900/80 backdrop-blur-sm border border-orange-600/40 rounded-lg flex items-center justify-between">
                            ...
                            <Link href="/auth/signin" className="text-xs text-white bg-orange-600 hover:bg-orange-500 px-2.5 py-1 rounded-lg font-bold transition-colors">Sign In</Link>
                          </div>
                        </div>
                      )}
                      <div className="flex items-start gap-3 mb-2">
