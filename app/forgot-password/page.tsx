    ...
    <main className="relative isolate min-h-screen overflow-hidden bg-[var(--color-surface-muted)]">
      ...
      <div className="pg-container relative z-10 py-16 lg:py-24">
        <div className="space-y-10">
          <section className="rounded-[32px] border border-[var(--color-border)] bg-[var(--color-surface)]/95 p-8 shadow-2xl backdrop-blur-xl md:p-12">
            ...
            <div className="mt-8 max-w-2xl rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-muted)]/90 p-5 md:p-6">
