...
import { 
  CheckCircle, Zap, Target, Clock, Calendar, BarChart3,
  ArrowRight, Users, Star, Phone, TrendingUp, AlertTriangle, ThumbsUp
} from 'lucide-react'
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            {/* Left: Content */}
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/20 backdrop-blur-sm rounded-full text-indigo-200 text-sm font-bold mb-4 border border-indigo-500/30">
                <Zap className="w-4 h-4" />
                <span>AI-Powered Strategic Analysis</span>
              </div>
              
              <h1 className="text-3xl md:text-4xl font-black text-white mb-4 leading-tight">
                Stop Wasting Time on Opportunities You Can't Win
              </h1>
              
              <p className="text-lg text-indigo-100 font-semibold mb-3 leading-relaxed">
                Our AI-powered bid/no-bid analysis helps you focus on winnable opportunities and avoid costly pursuits.
              </p>

              <p className="text-base text-indigo-200 mb-6">
                Not every opportunity is worth pursuing. Our data-driven analysis evaluates win probability, competitive positioning, and resource requirements—so you can make smarter bid decisions.
              </p>

              <div className="flex flex-wrap gap-3 mb-6">
                <Link
                  href="/contact?service=bid-no-bid"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white text-indigo-600 rounded-xl font-bold text-base shadow-xl hover:shadow-2xl hover:scale-105 transition-all"
                >
              ...
              <div className="flex flex-wrap items-center gap-4 text-indigo-100">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-sm">Win probability scoring</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4 text-indigo-300" />
                  <span className="font-semibold text-sm">24-48 hour turnaround</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <div className="text-4xl font-black text-white">3.2x</div>
                    <div className="text-sm font-bold text-indigo-200">Higher Win Rate</div>
                  </div>
                </div>
                <p className="text-sm text-indigo-200">Our clients win 3x more often when they follow our recommendations</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <div className="text-4xl font-black text-white">$8.4M</div>
                    <div className="text-sm font-bold text-indigo-200">Avg. Resources Saved</div>
                  </div>
                </div>
                <p className="text-sm text-indigo-200">By avoiding unwinnable bids, our clients save millions in pursuit costs</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-2xl font-black text-white">Strategic Partnership</div>
                    <div className="text-sm font-semibold text-indigo-200 mt-1">We help you win smarter, not just more</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-3">
              Comprehensive Bid/No-Bid Analysis
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Data-driven insights to make confident bid decisions
            </p>
          </div>
            ...
            {[
              ...
              <div key={idx} className="relative">
                <div className="bg-white rounded-2xl p-6 border-2 border-indigo-200 shadow-lg text-center">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 text-white text-2xl font-black flex items-center justify-center mx-auto mb-3 shadow-md">
                    {item.step}
                  </div>
      ...
      <section className="py-12 bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-indigo-100 mb-8 max-w-2xl mx-auto">
            Stop wasting resources on unwinnable opportunities. Let our AI-powered analysis help you focus on bids you can actually win.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <Link
              href="/contact?service=bid-no-bid"
              className="inline-flex items-center gap-2 rounded-xl bg-white text-indigo-600 px-8 py-4 text-lg font-bold shadow-xl hover:shadow-2xl hover:scale-105 transition-all"
            >
