...
export default function ProposalWritingPage() {
  return (
    <div className="mx-auto w-full max-w-[1920px] min-h-screen bg-gradient-to-br from-white via-gray-50 to-orange-50">
      <section className="relative overflow-hidden bg-gradient-to-br from-orange-900 via-orange-800 to-red-900">
        ...
        <div className="relative w-full px-3 sm:px-5 lg:px-6 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/20 backdrop-blur-sm rounded-full text-slate-100 text-sm font-bold mb-4 border border-orange-500/30">
                <Sparkles className="w-4 h-4" /><span>AI-Powered + Expert Review</span>
              </div>
              <h1 className="text-3xl md:text-4xl font-black text-white mb-4 leading-tight">Win More Contracts with Professional Proposals</h1>
              <p className="text-lg text-white font-semibold mb-3 leading-relaxed">Stop losing to better-written proposals. Our AI-powered service creates compelling, compliant proposals that win.</p>
              <p className="text-base text-slate-100 mb-6">We combine cutting-edge AI technology with expert federal contracting writers. The result? Proposals that stand out, meet compliance requirements, and demonstrate clear value.</p>
              <div className="flex flex-wrap gap-3 mb-6">
                <Link href="/contact?service=proposal-writing" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-orange-600 rounded-xl font-bold text-base shadow-xl hover:shadow-2xl hover:scale-105 transition-all"><Calendar className="w-5 h-5" />Get Started</Link>
              ...
              <div className="flex flex-wrap items-center gap-4 text-white">
                <div className="flex items-center gap-2"><Zap className="w-4 h-4 text-slate-200" /><span className="font-semibold text-sm">AI-powered drafting</span></div>
                <div className="flex items-center gap-2"><Award className="w-4 h-4 text-slate-200" /><span className="font-semibold text-sm">Expert review</span></div>
                <div className="flex items-center gap-2"><Clock className="w-4 h-4 text-slate-200" /><span className="font-semibold text-sm">Fast turnaround</span></div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="bg-white/20 backdrop-blur-sm border border-white/40 rounded-2xl p-6">
                <div className="flex items-center gap-4 mb-4"><Award className="w-12 h-12 text-emerald-400" /><div><div className="text-4xl font-black text-white">850+</div><div className="text-sm font-bold text-slate-100">Winning Proposals</div></div></div>
                <p className="text-sm text-slate-100">We've helped contractors win hundreds of millions in contracts</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm border border-white/40 rounded-2xl p-6">
                <div className="flex items-center gap-4 mb-4"><BarChart3 className="w-12 h-12 text-cyan-400" /><div><div className="text-4xl font-black text-white">73%</div><div className="text-sm font-bold text-slate-100">Win Rate</div></div></div>
                <p className="text-sm text-slate-100">Our proposals have a significantly higher win rate than industry average</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm border border-white/40 rounded-2xl p-6">
                <div className="flex items-center gap-4"><Users className="w-12 h-12 text-yellow-400" /><div><div className="text-2xl font-black text-white">Your Partner in Winning</div><div className="text-sm font-semibold text-slate-100 mt-1">Expert writers who understand federal contracting</div></div></div>
              </div>
            </div>
          </div>
        </div>
