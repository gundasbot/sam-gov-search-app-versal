...
export async function sendWelcomeEmail(data: WelcomeEmailData) {
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #1e293b; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.3);">
              ...
              <tr>
                <td style="background: linear-gradient(135deg, #06b6d4 0%, #3b82f6 100%); padding: 40px; text-align: center;">
                  ...
                  <p style="margin: 0; color: #e0f2fe; font-size: 16px;">You're all set up and ready to find opportunities</p>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding: 40px;">
                  ...
                  ${data.trialEnd ? `
                  <div style="background-color: #0c4a6e; border-left: 4px solid #06b6d4; padding: 16px; margin: 20px 0; border-radius: 6px;">
                  ...
                  <div style="background-color: #0f172a; border-radius: 12px; padding: 24px; margin: 30px 0;">
                    ...
                    <p style="margin: 0 0 16px; color: #06b6d4; font-size: 18px; font-weight: 600;">
                      ${planInfo.price}
                    </p>
                  ...
                  <div style="background-color: #0f172a; border-radius: 8px; padding: 16px; margin-bottom: 12px;">
                    <h4 style="margin: 0 0 8px; color: #06b6d4; font-size: 16px; font-weight: 600;">
                  ...
                  <div style="text-align: center; margin: 30px 0;">
                    <a href="${process.env.NEXT_PUBLIC_APP_URL}/search" style="display: inline-block; background: linear-gradient(135deg, #06b6d4 0%, #3b82f6 100%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-weight: 600; font-size: 16px;">
                      Start Searching Now
                    </a>
                  </div>
                  ...
                  <div style="background-color: #422006; border-left: 4px solid #f59e0b; padding: 16px; margin: 30px 0; border-radius: 6px;">
                    ...
                    <a href="${process.env.NEXT_PUBLIC_APP_URL}/settings/security" style="color: #fbbf24; text-decoration: underline; font-size: 13px;">
                  ...
                  <ul style="margin: 12px 0 0; padding-left: 20px; color: #cbd5e1; font-size: 14px; line-height: 24px;">
                    <li>Email: <a href="mailto:${process.env.SUPPORT_EMAIL}" style="color: #06b6d4; text-decoration: none;">${process.env.SUPPORT_EMAIL}</a></li>
                    <li>Help Center: <a href="${process.env.NEXT_PUBLIC_APP_URL}/help" style="color: #06b6d4; text-decoration: none;">Help Center</a></li>
                    <li>Schedule a call: <a href="${process.env.NEXT_PUBLIC_CALENDLY_LINK}" style="color: #06b6d4; text-decoration: none;">Book Time</a></li>
                  </ul>
                    ...
                    <tr>
                      <td align="center">
                        ...
                        <p style="margin: 0; color: #64748b; font-size: 12px;">
                          <a href="${process.env.NEXT_PUBLIC_APP_URL}/settings" style="color: #64748b; text-decoration: none;">Manage Subscription</a> •
                          <a href="${process.env.NEXT_PUBLIC_APP_URL}/privacy" style="color: #64748b; text-decoration: none;">Privacy Policy</a> •
                          <a href="${process.env.NEXT_PUBLIC_APP_URL}/terms" style="color: #64748b; text-decoration: none;">Terms of Service</a>
                        </p>
                      </td>
                    </tr>
                  </table>
  ...
  await sendEmail({
    to: data.to,
    subject: `Welcome to Precise GovCon - Your ${planInfo.name} is Active!`,
    html: htmlContent,
  })
}

// Also create a payment failed email
export async function sendPaymentFailedEmail(to: string, name: string, planName: string) {
  const htmlContent = `
    <!DOCTYPE html>
    <html>
    <!-- Similar structure but for payment failures -->
    <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #0f172a;">
      <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #0f172a; padding: 40px 0;">
        <tr>
          <td align="center">
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #1e293b; border-radius: 16px; overflow: hidden;">
              ...
              <tr>
                <td style="padding: 40px;">
                  ...
                  <div style="text-align: center; margin: 30px 0;">
                    <a href="${process.env.NEXT_PUBLIC_APP_URL}/settings/billing" style="display: inline-block; background-color: #dc2626; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-weight: 600;">
  ...
  await sendEmail({
    to,
    subject: 'Action Required: Payment Failed - Precise GovCon',
    html: htmlContent,
  })
}
